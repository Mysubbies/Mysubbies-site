...
test('zero-deposit booking bypasses Stripe and is stored for contract review', () => {
  assert.match(depositApi, /status: depositMilestone\.amount_cents === 0 \? 'pending_contract_review' : 'pending_deposit'/);
